...
CONTRACTS: tuple[Clause, ...] = (
    ...
    Clause(
        ...
        promise=(
            ...
            "SEZNAM ZÁKAZŮ MÁ DVA RŮZNÉ DRUHY A NESMÍ SE TO SETŘÍT "
            "*(W-83)*: zápor, podmínka a náhrada jsou LEXIKÁLNÍ "
            "(odvolatelná data, `ScopeOperator`), kdežto `:arg` je "
            "STRUKTURNÍ — pozná se z deprelu. Kdo narazí na strukturní "
            "případ a opraví ho přidáním SLOVA do seznamu, opravil "
            "nic: seznam slov strukturní vlastnost nepokryje. Je to "
            "táž past jako výčet slovních druhů v O-24, jen z druhé "
            "strany. "
    ...
    Clause(
        ...
        promise=(
            ...
            "nerika — zustavaji ztratou a hlasi se. POZOR: ten "
            "protipriklad PROCHAZI Z JINEHO DUVODU, nez hlida B-30 — "
            "radova cislovka neni holy letopocet, takze vypadne driv, "
            "nez se na spojku vubec nekdo zepta, a o rozhodovani podle "
            "spojky nerika nic. "
            "A USEK POZNA SPOJKA, NE TO, ZE JSOU OBOJI LETOPOCTY "
            "*(B-30)*. Prvni verze skladala kazdy konjunkt letopoctu, "
            "takze „v letech 1910 NEBO 1920“ dalo TYZ UZEL jako "
            "„1910 - 1911“: veta rika, ze se nevi ktery, a baze by "
            "tvrdila jeden cas — a bylo to TICHE, bez [ZAHOZENO] a bez "
            "otazky. Pojistka „bud je usek v uzlu cely, nebo tam ztrata "
            "zustane“ hlidala jen JEDEN SMER; ten, ktery vyrabi "
            "nepravdu, je opacny. "
            "Rozhoduje se z rozboru: bez spojovaciho SLOVA (pomlcka) je "
            "to USEK; se spojovacim slovem („a“, „nebo“, carkovy "
            "vycet) VIC CASU nebo NEZNAMO KTERY, tedy se NESKLADA; "
            "predlozka `mezi` je usek i se spojkou a je to jedina "
            "vyjimka, dolozena korpusem. Pta se to CELE KOORDINACE, ne "
            "jedne hrany („1910, 1911 A 1912“ nese `cc` az u "
            "posledniho clenu). "
            "SPOJOVACI SLOVO SE POZNA PISMENY, NE ZNACKOU `cc`: taz "
            "pomlcka dostane od parseru jednou `PUNCT/punct` a jednou "
            "`ADP/cc` (overeno na zive sluzbe, „1910 - 1911“ x "
            "„1925 - 1933“), takze podminka na `cc` jeden skutecny "
            "usek rozbila. "
            ". ROZSAH MERENI: korpus 238 vet, TAZ POPULACE NA OBOU "
